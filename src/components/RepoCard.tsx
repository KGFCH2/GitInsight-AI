...
export function RepoCard({ repo, index = 0 }: { repo: AnalyzedRepo; index?: number }) {
  return (
    <motion.a
      ...
      className="group flex h-full flex-col rounded-xl glass-card p-5 transition-all hover:-translate-y-0.5"
    >
      <div className="mb-2 flex items-start justify-between gap-3">
        <div className="flex items-center gap-2 font-display text-base font-bold leading-tight text-gradient">
          {repo.name}
          {repo.isFork && (
