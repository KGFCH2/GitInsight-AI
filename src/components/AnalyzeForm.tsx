      ...
      >
        <div className="flex flex-1 items-center gap-2 px-3">
          ...
          <input
            ...
            className="flex-[2] h-10 min-w-[220px] border-none bg-transparent text-sm outline-none focus:outline-none focus:ring-0 focus-visible:ring-0 shadow-none placeholder:text-foreground/70 dark:placeholder:text-muted-foreground"
            spellCheck={false}
            autoComplete="off"
          />
        </div>
