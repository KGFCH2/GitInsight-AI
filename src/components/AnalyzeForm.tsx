      ...
      >
        <div className="flex flex-1 items-center gap-3 px-3">
          ...
          <Input
            ...
            className="h-10 border border-black rounded-lg bg-transparent text-base shadow-none outline-none ring-0 focus-visible:outline-none focus-visible:ring-0 dark:border-white"
            spellCheck={false}
            autoComplete="off"
          />
        </div>
