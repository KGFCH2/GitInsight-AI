        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2">
          {history.map((item) => (
            <Link
              ...
              className="group flex items-center gap-4 rounded-2xl border border-border bg-card-grad p-4 transition-all hover:-translate-y-1 hover:border-brand-1/40 hover:shadow-glow"
            >
              <img
                src={item.avatar}
                alt={item.login}
