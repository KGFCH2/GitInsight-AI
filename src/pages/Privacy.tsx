const Privacy = () => (
  <div className="container max-w-3xl py-12">
    ...
    <div className="prose prose-sm mt-8 max-w-none text-foreground/90">
      ...
      <h2 className="hover-pop mt-6 font-display text-xl font-bold">What we access</h2>
      ...
      <h2 className="hover-pop mt-6 font-display text-xl font-bold">AI processing</h2>
      ...
      <h2 className="hover-pop mt-6 font-display text-xl font-bold">Cookies</h2>
